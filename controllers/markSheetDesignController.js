const MarksheetDesign = require('../models/MarkSheetDesign')
...
exports.getAllDesign = async (req, res, next) => {
  ...
  try {
    ...
    let data = await MarksheetDesign.findAll({
...
exports.getDesign = async (req, res, next) => {
  ...
  try {
    ...
    let data = await MarksheetDesign.findByPk(req.params.id)
  ...
  try {
    ...
    upload(req,res,async(err)=>{
      ...
      req.body.background_image = req.files.background_image[0].path
        ...
        let data = await MarksheetDesign.create(req.body)
